...
-- лучше так:
SELECT department_id, name, manager
FROM departments;
...
-- Выведем колонки в другом порядке
...
-- Часто используют первичный ключ
DELETE FROM employees
WHERE employee_id = 7;
...
UPDATE employees
SET full_name = 'Сидоров Петр Иванович'
