...
public class MapDemo {
    public static void main(String[] args) {
        ...
        // Здесь Integer - тип ключа, String - тип значения
        ...
        // При добавлении значения с существующим ключом
        // значение изменяется
        ...
        // Ключи могут быть и других типов
        ...
        // Инициализация через Map.of (c Java 9) 
        Map<Integer, String> WORDS = Map.of(
             100, "сто",
             200, "двести",
             300, "триста",
             400, "четыреста",
