...
//         bitSet();
    ...
    static void binaryFormat() {
        long b = 0b1010; //0b - признак бинарной системы счисления
        System.out.println("in decimal:" + b);
        System.out.println("asBinString:" + Long.toBinaryString(b));

        int one = 1; // 0000_0000_0000_0000_0000_0000_0000_0001
        System.out.println("oneAsBinString:" + Integer.toBinaryString(one));
        int minusOne = -1; // 1111_1111_1111_1111_1111_1111_1111_1111
        // 1 * 2 ^ 0 = 1
        // +
        // 1 * 2 ^ 1 = 2
        // +
    ...
    static void octalHexFormat() {
        ...
        int xHex = 0xFF; // 0b1111_1111
        System.out.println("xHex:" + xHex);
        System.out.println("xHex:" + Integer.toHexString(xHex));
        System.out.println("xHex:" + Integer.toBinaryString(xHex));
    }
    ...
    private static void bitwiseOperations() {
        ...
        // логическое ИЛИ
        long resultOr = x1 | x2;
        // 10 -> 0000_0000_0000_0000_0000_0000_0000_0010
        // 10 -> 1111_1111_1111_1111_1111_1111_1111_1101
        // 11
        // 11
...
//       101
        ...
        // & - 1 будет если оба бита 1, остальное
        // |  -  1 если один из битов 1
        ...
        // 0111_1111_1111_1111_1111_1111_1111_1101
        ...
        // XOR
        long resultXOr = x1 ^x2;
        // 10
        // 11
        // 01
        System.out.println("resultXOr:" + Long.toBinaryString(resultXOr));
    }
    ...
    static void bitOperations() {
        ...
        // 0000000000000000000000000000_1100
        // 0000000000000000000000000000_1000
    ...
    static void bitSet() {
        ...
        // 0000_0000_0000_0000_0000_0000_0000_0001
        // 0000_0000_0000_0000_0000_0001_1111_1110
